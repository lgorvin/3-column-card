    ...
    <div className="flex justify-center items-center lg:h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-3 my-8">
        <div className="card1 hover:scale-110 rounded-t-lg lg:rounded-l-lg lg:rounded-tl-lg lg:rounded-t-none h-[450px] lg:h-[500px] w-[350px] duration-200">
          ...
          <h1 className="font1 text-5xl text-white ml-12">SEDANS</h1>
          <p className="font2 white ml-12 mt-8">
            Choose a sedan for its <br /> affordability and excellent fuel{" "}
            <br />
            economy. Ideal for cruising in <br /> the city or on your next road{" "}
            <br />
            trip
          </p>
          <button className="bg-white orange hover:border-2 border-white hover:text-white font2 ml-12 mt-8 lg:mt-16 rounded-3xl py-3 px-8 duration-300">
            Learn More
          </button>
        </div>
        <div className="card2 h-[450px] lg:h-[500px] w-[350px] hover:scale-110 duration-200">
          ...
          <h1 className="font1 text-5xl text-white ml-12">SUVS</h1>
          <p className="font2 white ml-12 mt-8">
            Take an SUV for its spacious <br /> interior, power, and
            versatility. <br />
            Perfect for your next family <br /> vacation and off-road <br />
            adventures
          </p>
          <button className="bg-white cyan hover:border-2 border-white hover:text-white font2 ml-12 mt-8 lg:mt-16 rounded-3xl py-3 px-8 duration-300">
            Learn More
          </button>
        </div>
        <div className="card3 rounded-b-lg lg:rounded-l-lg lg:rounded-tr-lg lg:rounded-t-none lg:rounded-bl-none h-[450px] lg:h-[500px] w-[350px] hover:scale-110 duration-200">
          ...
          <h1 className="font1 text-5xl text-white ml-12">LUXURY</h1>
          <p className="font2 white ml-12 mt-8">
            Cruise in the best car brands <br /> without the bloated prices.
            <br />
            Enjoy the enhanced comfort of <br />a luxury rental and arrive in{" "}
            <br />
            style
          </p>
          <button className="bg-white darkCyan hover:border-2 border-white hover:text-white font2 ml-12 mt-8 lg:mt-16 rounded-3xl py-3  px-8 duration-300">
            Learn More
          </button>
        </div>
      </div>
